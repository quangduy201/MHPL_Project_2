...
public class BarChart extends javax.swing.JPanel {
    ...
    private List<ModelBarLegend> legends = new ArrayList<>();
    ...
    public BarChart() {
        ...
        blankPlotChart.setBlankPlotChatRender(new BlankPlotBarChatRender() {
            @Override
            ...
            @Override
            public void renderSeries(BlankPlotBarChart chart, Graphics2D g2, SeriesSize size, int index) {
                double totalSeriesWidth = (seriesSize * legends.size()) + (seriesSpace * (legends.size() - 1));
                double x = (size.getWidth() - totalSeriesWidth) / 2;
                for (int i = 0; i < legends.size(); i++) {
                    ModelBarLegend legend = legends.get(i);
    ...
    public void addLegend(String name, Color color) {
        ModelBarLegend data = new ModelBarLegend(name, color);
        legends.add(data);
        panelLegend.add(new BarLegendItem(data));
        panelLegend.repaint();
    ...
    private void initComponents() {
        ...
        blankPlotChart = new com.example.project_2.components.charts.BlankPlotBarChart();
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(blankPlotChart, javax.swing.GroupLayout.DEFAULT_SIZE, 354, Short.MAX_VALUE)
                .addGap(0, 0, 0)
    ...
    private com.example.project_2.components.charts.BlankPlotBarChart blankPlotChart;
