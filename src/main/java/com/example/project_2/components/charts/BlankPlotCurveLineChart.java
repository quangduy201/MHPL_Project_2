...
public class BlankPlotCurveLineChart extends JComponent {
    ...
    public BlankPlotCurveLineChatRender getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChatRender(BlankPlotCurveLineChatRender blankPlotChatRender) {
    ...
    private BlankPlotCurveLineChatRender blankPlotChatRender;

    public BlankPlotCurveLineChart() {
