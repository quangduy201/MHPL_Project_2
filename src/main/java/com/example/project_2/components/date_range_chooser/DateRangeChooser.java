...
public class DateRangeChooser extends JPanel {
    ...
    public void setSelectedDateBetween(DateRangeBetween dateBetween, boolean displayLast) {
        setSelectedDateBetween(
    ...
    public Date getSelectedDate() throws DateRangeChooserException {
    ...
    private void setSelectedDate(RDate date) throws DateRangeChooserException {
    ...
    public DateRangeBetween getSelectedDateBetween() throws DateRangeChooserException {
        if (dateSelectionMode == DateSelectionMode.SINGLE_DATE_SELECTED) {
            throw new DateRangeChooserException("Date chooser is current SINGLE_DATE_SELECTED mode");
        }
        if (selectedCount != 2) {
            throw new DateRangeChooserException("Date between not selected");
        }
        DateRangeBetween dateBetween = new DateRangeBetween(selectedDateBetween[0].toDate(), selectedDateBetween[1].toDate());
        dateBetween.fixDate();
        return dateBetween;
    }

    public void setSelectedDateBetween(DateRangeBetween dateBetween) {
        setSelectedDateBetween(
    ...
    private void createHeader() {
        ...
        AbstractDocument doc =
                new PlainDocument() {
                    ...
                    public void setDocumentFilter(DocumentFilter filter) {
                        if (filter instanceof DateRangeChooserEditorDocumentFilter) {
        ...
        doc.setDocumentFilter(new DateRangeChooserEditorDocumentFilter());
    ...
    private void displayDate() {
        if (textField != null) {
            if (dateSelectionMode == DateSelectionMode.SINGLE_DATE_SELECTED) {
                ...
                DateRangeBetween dateBetween = new DateRangeBetween();
